...
void Cloud::initialize() {
    ...
    /* sendMessagePower[0] = 234;  // sent by smartphone
    sendMessagePower[1] = 112;  // sent by computer

    receiveMessagePower[0] = 431;  // received by smartphone
    receiveMessagePower[1] = 352;  // received by computer */
